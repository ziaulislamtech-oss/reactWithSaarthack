  ...
  return (
    <div className='parent'>
     {jobOpenings.map(function(elem,idx){
      console.log(idx)
      return <Card key={idx} logo={elem.brandLogo} company={elem.companyName} date ={elem.datePosted} location ={elem.location} salary={elem.pay} position={elem.post} timing1={elem.tag1} timing2={elem.tag2} />
     })}
